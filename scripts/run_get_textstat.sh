#!/bin/bash
# - Name     : run_get_textstat.sh
# - Purpose  : get textstat
# - Date     : 30, Mar, 2020
# - Author   : Donggu, Lee
#######################################################################
...
# File paths
SCRIPT_FILE_NAME='get_textstat.py'
...
if [[ "$#" -eq 2 || "$#" -eq 3 ]]; then
    ...
    echo "\$./run_get_textstat.sh [YYYYMM] [Thread Count]"
    echo "\$./run_get_textstat.sh 202001 5"
    echo "**************************************************************"
    exit 0   
fi
